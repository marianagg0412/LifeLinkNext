    ...
    <div className={tw(`min-h-screen bg-gray-100`)}>
        ...
        <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8`)}>
          <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
            <div className={tw(`mb-16 text-center`)}>
              <h4 className={tw(`text-base text-[#FF5A5A] font-semibold tracking-wide uppercase`)}>¿Quiénes Somos?</h4>
              <p className={tw(`mt-2 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900`)}>
                En LifeLink, creemos en el poder de la comunidad y la solidaridad para salvar y transformar vidas.
              </p>
            </div>
            <div className={tw(`flex flex-wrap my-12`)}>
              <div className={tw(`w-full lg:w-1/2 p-8`)}>
                <h2 className={tw(`text-3xl font-bold text-gray-900 mb-4`)}>Nuestra Misión</h2>
                <p className={tw(`leading-loose text-gray-500 mb-8`)}>
                ...
                <h2 className={tw(`text-3xl font-bold text-gray-900 mb-4`)}>Nuestra Visión</h2>
                <p className={tw(`leading-loose text-gray-500 mb-8`)}>
      ...
      <section className={tw(`bg-white pb-6`)}>
        <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8`)}>
          <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
            <div className={tw(`mb-16 text-center`)}>
              <h4 className={tw(`text-base text-[#FF5A5A] font-semibold tracking-wide uppercase`)}>Nuestros Valores</h4>
            </div>
            <div className={tw(`flex flex-wrap my-12`)}>
              {values.map((value, index) => (
                <div key={index} className={tw(`w-full lg:w-1/2 p-8`)}>
                  <div className={tw(`flex items-center mb-6`)}>
                    ...
                    <div className={tw(`ml-4 text-xl font-semibold`)}>{value.title}</div>
                  </div>
      ...
      <section className={tw(`bg-white pb-6`)}>
        <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8`)}>
          <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
            <div className={tw(`mb-16 text-center`)}>
              <h4 className={tw(`text-base text-[#FF5A5A] font-semibold tracking-wide uppercase`)}>Nuestro Equipo</h4>
              <p className={tw(`mt-2 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900`)}>
