...
const Login2 = () => {
    const router = useRouter();
     ...
     return (
        <section className={tw`bg-grey-100 dark:bg-gray-900`}>
                    ...
                    <div className={tw`p-6 space-y-4 md:space-y-6 sm:p-8`}>
                        ...
                        <form onSubmit={(e) => {
                            ...
                            <div className={tw`mb-5`}>
                                <label htmlFor="email" className={tw`block mb-2 text-sm font-medium text-gray-900 dark:text-white`}>Correo</label>
                                <Input 
                                    type="email" 
                                    name="email" 
                                    value={email} 
                            ...
                            <button type="submit" className={tw`bg-blue-100 w-full text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800`}>Inicia Sesion</button>
