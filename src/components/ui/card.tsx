...
const CardTitle = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={tw("text-2xl font-semibold leading-none tracking-tight", className)} {...props} />
));
...
const CardDescription = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={tw("text-sm text-gray-500 dark:text-gray-400", className)} {...props} />
));
